...
date2:  2020-01-17 00:00:00 -0400
categories: [GWU]
docclass: "lab"
gwclass: "cs1012"
term: "sp20"
...
In lab, you will be evaluated on your efforts in lab and you must show your work to the instructors before you leave lab.  For every exercise you will be evaluated on three parts:

1. Effort
2. Working solution
3. Comprehension

Effort will be assessed throughout the lab.  If you are not working on the exercises, you will not receive credit for effort.

We will work through most solutions together after you have attempted to solve them on your own.  Before you leave lab, you need to show the instructor that 1) you have a working solution and 2) you understand the solution through adding your own personal comments into the code.

### Comments

Programming involves not only writing code but also documenting code using natural language.  In your reading, you will find several ways to indicate to Python that certain lines are comments and are to be ignored when the program is executed.  For now, indicate a comment using the hash ```#``` symbol.  Anything that follows the ```#``` until the end of line will be ignored by Python.  For example, this is a simple program with comments:

```python
# This is a comment.
print('Hello World!')    # (Also a comment) Print a message to the screen
```

We will talk about comments more later.
...
Earlier this week, we discussed how to draw a square.  The instructions below will draw a square using python turtle.  For this exercise, you will draw a square using the interactive prompt and take a screenshot of the resulting drawing.
...
#### A Revised Square Program

Given the above fixes, the square program should now look like the following code.
...
Write this program and include comments in it to indicate your understanding of the program.  Show the program to the instructor to receive your evaluation.
