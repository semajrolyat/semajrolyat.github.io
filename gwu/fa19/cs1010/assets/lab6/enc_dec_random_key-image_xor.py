...
# 1. encryption method: XOR a uniform random generated float between [0, 1]
# to each pixel; then decrypt
...
k = np.zeros((pix.shape[0], pix.shape[1]), dtype="int16")
